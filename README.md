...
This repository contains a hardware-based cipher written in Verilog, designed for manufacturing on a custom silicon chip via the [TinyTapeout](https://tinytapeout.com) project. 
